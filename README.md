...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:58A6FF,100:1F6FEB&height=180&section=header&text=Lucas%20Vel%C3%B4so&fontSize=46&fontColor=ffffff&animation=fadeIn&fontAlignY=36&desc=Automation%20Engineer%20%C2%B7%20Backend&descAlignY=58&descSize=18&descColor=e6edf3" width="100%" alt="header"/>

<a href="https://github.com/oveloso">
  <img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=500&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&width=620&lines=Automation+Engineer;Backend+Developer;Python+%C2%B7+AWS+%C2%B7+Serverless;Integra%C3%A7%C3%B5es+%C2%B7+APIs+%C2%B7+IA+aplicada" alt="roles"/>
</a>
...
Backend e automação em **Python**, **Node.js/TypeScript** e **AWS serverless**. Integração de sistemas, APIs e IA aplicada (RAG + agentes).
